...
If you wish to perform these steps on a list of multiple groups (in same domain), check out "[v1]-Export_Members-of-Many-Groups.ps1"...
And, if you wish to perform these steps on a list of multiple groups (of multiple domains), check out "[v2]-Export_Members-of-Many-Groups.ps1"
- - -
