...
If you wish to perform these steps on a list of multiple groups (in same domain), check out [v1.2] of this script.
- - -

Values within angle brackets <> are to be replaced by users with actual values...
PLEASE REMOVE ANGLE BRACKETS (<>) & DO NOT REMOVE DOUBLE QOUTES ("") WHEN YOU SUPPLY ACTUAL VALUES
#>
